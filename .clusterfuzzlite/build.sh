#!/bin/bash -eu
# ClusterFuzzLite build script — installs shrinkage and compiles each Python
...
# environment so PyInstaller can discover and bundle shrinkage into each frozen
# fuzzer binary.
pip3 install .
...
# numpy submodule, data file and shared library. scipy is bundled correctly via
# the static import graph and PyInstaller's built-in hooks.
